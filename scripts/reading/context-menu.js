...
function saveImage() {
	...
	const image = reading.getImage(reading.currentPageIndex()) || reading.getImageByPosition(position, 0);
...
async function copyImageToClipboard() {
	const position = reading.currentImagePosition();
	const _image = reading.getImage(reading.currentPageIndex()) || reading.getImageByPosition(position, 0);
